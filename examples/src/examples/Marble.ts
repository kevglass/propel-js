...
export function marbleInit(): physics.World {
    ...
    const marble1 = physics.createCircle(world, { x: 245, y: -200 }, 20, 2, 0.3, 0.5);
    physics.addBody(world, marble1);

    const marble2 = physics.createCircle(world, { x: 275, y: -300 }, 20, 2, 0.3, 0.3);
    ...
    const wheel = physics.createRigidBody(world, { x: 200, y: 400 }, 1, 0, 0.3, [wheelWing1, wheelWing2]);
