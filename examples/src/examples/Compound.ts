...
// simple shapes
export function compoundInit(): physics.World {
    ...
    const body = physics.createRigidBody(world, { x: 255, y: 50 }, 1, 0.5, restitution, [shape1, shape2, shape3]);
    ...
    const body2 = physics.createRigidBody(world, { x: 145, y: 0 }, 1, 0.5, restitution, [shape4, shape5]);
