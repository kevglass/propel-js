...
export function sensorInit() {
    ...
    const shape = physics.createRectangleShape(world, { x: 255, y: 0 }, 40, 40);
    const sensor = physics.createRectangleShape(world, { x: 255, y: 20 }, 40, 10, 0, true);
    const box = physics.createRigidBody(world, { x: 255, y: 0 }, 1, 1, 0, [shape, sensor]);
