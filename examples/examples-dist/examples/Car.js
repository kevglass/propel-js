...
export function carInit() {
    ...
    world.damp = 0.99;
    const friction = 0.5;
    let rect = physics.createRectangle(world, { x: 150, y: 80 }, 400, 30, 0, friction, 0.5);
    physics.rotateBody(rect, Math.PI / 6);
    physics.addBody(world, rect);
    rect = physics.createRectangle(world, { x: 350, y: 250 }, 400, 30, 0, friction, 0.5);
    physics.rotateBody(rect, -Math.PI / 8);
    physics.addBody(world, rect);
    rect = physics.createRectangle(world, { x: 150, y: 420 }, 400, 30, 0, friction, 0.5);
    physics.rotateBody(rect, Math.PI / 8);
    physics.addBody(world, rect);
    const circle1 = physics.createCircle(world, { x: 50, y: 0 }, 15, 3, friction, 1);
    physics.addBody(world, circle1);
    const circle2 = physics.createCircle(world, { x: 90, y: 0 }, 15, 3, friction, 1);
